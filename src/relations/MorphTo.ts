...
export default class MorphTo {
  /**
   * generate lookup, select and exclude for MorphTo relation 
   *
   * @param Model target
   * @param string name
   * @param string type
   ...
   */
  static generate(target: typeof Model, name: string, type: string, id: string, ownerKey: string = "_id", alias: string, options: IRelationOptions): Document[] {
  ...
  /**
   * generate lookup for MorphTo relation 
   *
   * @param Model target
   * @param string name
   * @param string type
   ...
   * @return mongodb/Document[] 
   */
  static lookup(target: typeof Model, name: string, type: string, id: string, ownerKey: string = "_id", alias: string): Document[] {
