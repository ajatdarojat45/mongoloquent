...
export default class Query extends Database {
	...
	/**
	 * @note This property identifies the field name for the soft delete flag.
	 * @var {string}
	 */
	public static $IS_DELETED: string = "IS_DELETED";

	/**
	 * @note This property identifies the field name for the soft delete timestamp.
	 * @var {string}
	 */
	 ...
	 * @param  {"and" | "or"} [boolean="and"] - The boolean operator to use (and/or).
	 * @return {this} The current query instance.
	 */
